...
const V8_STACK = `Error: test
    ...
    at Object.<anonymous> (/home/user/app/node_modules/@centry/sdk/src/captureLog.ts:42:3)
...
describe('parseStack', () => {
  ...
  it('strips frames whose filename contains @centry/sdk', () => {
    const frames = parseStack(V8_STACK);
    const internal = frames.filter((f) => f.filename.includes('@centry/sdk'));
